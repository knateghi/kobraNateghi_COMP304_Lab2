    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.condominium_apartment:
                Toast.makeText(CondominiumActivity.this, "You click Show Condominium", Toast.LENGTH_SHORT).show();
                return true;
            case R.id.town_house:
                Toast.makeText(CondominiumActivity.this, "You click Show Town House", Toast.LENGTH_SHORT).show();
                return true;
            default:
